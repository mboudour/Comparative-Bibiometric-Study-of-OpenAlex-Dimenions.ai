...
PSCORE_CONFIGS = [
    ...
    ("coauthorship_norm_w0_d0.pkl",           4.3333, "Co-authorship Network",            "Normalized"),
    ("coauthorship_w0_d0.pkl",                2638.0, "Co-authorship Network",            "Raw"),
    ("bibliographic_coupling_norm_r0_d0.pkl", 39.4638,"Bibliographic Coupling Network",   "Normalized"),
    ("bibliographic_coupling_r0_d0.pkl",      1181.0, "Bibliographic Coupling Network",   "Raw"),
    ("concept_cooccurrence_norm_c0_d0.pkl",   29.0,   "Concept Co-occurrence Network",    "Normalized"),
    ("concept_cooccurrence_c0_d0.pkl",        38402.0,"Concept Co-occurrence Network",    "Raw"),
]
