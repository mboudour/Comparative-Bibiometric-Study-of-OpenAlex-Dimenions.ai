...
COMMANDS = [
    ...
    ["python", "visualize_biblio_graphs.py", "coauthorship_w0_d0.pkl",      "--min_degree", "206"],

    # bibliographic coupling
    ["python", "visualize_biblio_graphs.py", "bibliographic_coupling_norm_r0_d0.pkl", "--min_degree", "154.86"],
    ["python", "visualize_biblio_graphs.py", "bibliographic_coupling_r0_d0.pkl",      "--min_degree", "7418"],

    # concept co-occurrence
    ["python", "visualize_biblio_graphs.py", "concept_cooccurrence_norm_c0_d0.pkl", "--min_degree", "4.0"],
    ["python", "visualize_biblio_graphs.py", "concept_cooccurrence_c0_d0.pkl",      "--min_degree", "222"],
]
